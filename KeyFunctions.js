...
function getPageIcon(pathname, pageName) {
  // Map common page types to icons
  const iconMap = {
    '/': '🏠',
    '/home': '🏠', 
    '/about': '👤',
  ...
  // Check for keywords in pathname or page name
  const searchText = (pathname + ' ' + pageName).toLowerCase();
